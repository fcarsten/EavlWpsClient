...
compdataImp=imputationNA(compdata,codaFirstC,codaLastC) #THIS IS A SLOW STEP
#compdataImp=compdata 

output = "impnaout"
write.csv(compdataImp, output,row.names=FALSE)
