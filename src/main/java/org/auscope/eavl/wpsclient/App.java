...
public class App
{
    ...
    {
        WpsClient client = new WpsClient("http://130.56.250.15:8080/wps/WebProcessingService");
        try {
            System.out.println(client.imputationNA(5, 65, DATA));
